...
#figure(
  lq.diagram(
    lq.boxplot(
      (9, 8, 7, 11, 5, 10, 5, 12, 8, 8, 8, 9, 5, 10, 7, 11, 6, 8, 5, 9),
    ),
    lq.boxplot(
      (6, 5, 9, 8, 9, 7, 8, 9, 7, 6, 9, 7, 2, 8, 10, 9, 7, 6, 8, 7),
      x: 2,
    ),
  ),
  caption: "Besiegte Gegner",
)

#figure(
  lq.diagram(
    lq.boxplot(
      (5, 4, 4, 5, 3, 5, 3, 5, 2, 4, 3, 5, 3, 5, 4, 5, 3, 4, 3, 5),
    ),
    lq.boxplot(
      (4, 3, 5, 4, 4, 4, 1, 2, 3, 3, 4, 4, 4, 4, 5, 4, 4, 3, 4, 4),
      x: 2,
    ),
  ),
  caption: "Kaufwahrscheinlichkeit",
)
...
#figure(
  lq.diagram(
    ...
    lq.boxplot(
      (2, 2, 3, 2, 2, 2, 2, 4, 3, 2, 3, 2, 2, 2, 3, 2, 2, 2, 3, 2),
      x: 2,
    ),
  ),
  caption: "Einschätzung Eingabeverzögerung",
)

#figure(
  lq.diagram(
    lq.boxplot(
      (4, 3, 5, 4, 5, 4, 5, 4, 5, 3, 5, 4, 5, 4, 5, 4, 5, 3, 5, 4),
    ),
    lq.boxplot(
      (5, 4, 4, 5, 3, 5, 3, 5, 2, 4, 3, 5, 3, 5, 4, 5, 3, 4, 3, 5),
      x: 2,
  ...
  caption: "Einschätzung Bildqualität",
)

#figure(
  lq.diagram(
    lq.boxplot(
      (5, 4, 4, 5, 3, 5, 4, 5, 5, 4, 3, 5, 4, 5, 4, 5, 4, 4, 3, 5),
    ),
    lq.boxplot(
      (4, 2, 3, 4, 5, 4, 4, 4, 5, 3, 5, 4, 5, 4, 5, 4, 4, 3, 5, 4),
      x: 2,
    ),
  ),
  caption: "Spielspaß",
